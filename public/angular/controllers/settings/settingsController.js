angular.module('Curve')
  .controller('settingsController', ['$scope', '$routeParams', 'Session', 'Client', 'Parent', 'Payee', 'User', 'Notification', 'Loader', 'Currencies', 'Upload',
    function($scope, $routeParams, Session, Client, Parent, Payee, User, Notification, Loader, Currencies, Upload) {
      var controller = this;
      ...
      $scope.statementDesigns = ["Standard"];
      ...
      function upload(file, callback) {
        Upload.upload({
            url: Session.apiUrl + '/clients/' + $scope.client._id + '/upload' + $scope.token,
            method: 'POST',
            data: {
              file: file
            }
